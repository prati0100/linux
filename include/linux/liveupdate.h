 ...
 * @retrieved: The retrieve status for the 'can_finish / finish' operation.
 * @file:      The file object.
 *             For retrieve: [OUT] The callback sets this to the new file.
 *             For other ops: [IN] The caller sets this to the file being
 *             operated on.
 * @data:      The opaque u64 handle, preserve/prepare/freeze may update this
 *             field.
 *
...
static int liveupdate_init_flb(struct liveupdate_flb *flb)
{
}
