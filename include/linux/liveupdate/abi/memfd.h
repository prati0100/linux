 ...
 *     - folios: binary blob
 *       A contiguous array of &struct memfd_luo_folio_ser, one for
 *       each preserved folio from the original file's mapping.
 */
...
/* The compatability string for memfd file handler */
