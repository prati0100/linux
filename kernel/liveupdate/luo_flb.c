...
/*
 * luo_flb_get_private - Access private private field, and if needed
 * initialize it.
 */
			    ...
			    struct liveupdate_flb *flb)
{
	...
	if (!private->users) {
		...
		list_for_each_entry(gflb, &luo_flb_global.list, private.list) {
...
void luo_flb_serialize(void)
{
	...
	list_for_each_entry(flb, &luo_flb_global.list, private.list) {
		struct luo_flb_private *private = luo_flb_get_private(flb);
